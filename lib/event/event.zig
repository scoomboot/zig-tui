...
// docs   : https://github.com/fisty/zig-tui/docs/event
...
// ╔══════════════════════════════════════ INIT ══════════════════════════════════════╗
    ...
    pub const EventListener = *const fn (event: Event) void;
...
// ╔══════════════════════════════════════ CORE ══════════════════════════════════════╗
    ...
    // ┌──────────────────────────── Event Handler ────────────────────────────┐
        ...
        /// Event handler structure for managing event queue and input processing.
        pub const EventHandler = struct {
            ...
            ///
            /// Creates a new event handler with the provided allocator.
            ///
            /// __Parameters__
            ///
            ...
            /// __Return__
            ///
            /// - Initialized EventHandler or error
            ...
            /// __Parameters__
            ///
            /// - `self`: EventHandler instance to deinitialize
            ...
            ///
            /// Attempts to read and process events without blocking.
            ///
            /// __Parameters__
            ///
            /// - `self`: EventHandler instance
            ///
            /// __Return__
            ///
            /// - Optional Event if available, null otherwise
            ...
            /// Push event to queue.
            ///
            /// Adds an event to the internal queue.
            ///
            /// __Parameters__
            ///
            /// - `self`: EventHandler instance
    ...
    // ┌──────────────────────────── Event Dispatcher ────────────────────────────┐
        ...
        pub const EventDispatcher = struct {
            ...
            /// __Parameters__
            ///
            /// - `self`: EventDispatcher instance to deinitialize
            ...
            /// __Parameters__
            ///
            /// - `self`: EventDispatcher instance
            /// - `listener`: Event listener callback to add
            ...
            ///
            /// - `self`: EventDispatcher instance
            /// - `event`: Event to dispatch to listeners
